...
function voiceChat(audioBuffer_1) {
    return __awaiter(this, arguments, void 0, function (audioBuffer, voice, inputFormat, outputFormat) {
...
function voiceChatStream(audioBuffer_1) {
    return __awaiter(this, arguments, void 0, function (audioBuffer, voice, inputFormat) {
...
function textToSpeech(text_1) {
    return __awaiter(this, arguments, void 0, function (text, voice, format) {
...
function speechToText(audioBuffer_1) {
    return __awaiter(this, arguments, void 0, function (audioBuffer, format) {
        var file, response;
        if (format === void 0) { format = "wav"; }
        return __generator(this, function (_a) {
            switch (_a.label) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, (function () {
                            return __asyncGenerator(this, arguments, function () {
                                var _a, stream_3, stream_3_1, event_1, e_3_1;
                                var _b, e_3, _c, _d;
                                return __generator(this, function (_e) {
                                    switch (_e.label) {
                                        case 0:
                                        ...
                                        case 2:
                                            ...
                                            _a = false;
                                            event_1 = _d;
                                            if (!(event_1.type === "transcript.text.delta")) return [3 /*break*/, 5];
                                            return [4 /*yield*/, __await(event_1.delta)];
